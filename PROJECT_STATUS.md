...
## Latest Updates
- **[11 Aug 2026]** Deferred the closed cart drawer into an on-demand client chunk and self-hosted EB Garamond / Plus Jakarta Sans with `next/font` variable faces, removing the Google Fonts CSS dependency while preserving the checkout flow and storefront typography.
