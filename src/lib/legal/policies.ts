...
const en: Record<LegalSlug, LegalPolicy> = {
  privacy: {
    ...
    sections: [
      { heading: '1. Who we are', paragraphs: ['Praba Leather Bali is a Bali-based leather goods studio and online storefront. For privacy questions or requests, contact our team at hello@prabaleather.com or +62 818 0459 5666.'] },
    ...
    contactBody: 'Email hello@prabaleather.com or call +62 818 0459 5666. We aim to acknowledge privacy requests within seven days and respond after verifying the request.',
  },
  terms: {
    ...
    sections: [
      ...
      { heading: '9. Contact and governing context', paragraphs: ['Questions, complaints, and order issues should first be sent to hello@prabaleather.com. These terms are intended to be read with the laws applicable to Praba Leather Bali’s operations in Indonesia and the mandatory consumer protections that apply to your purchase.'] },
    ],
    contactHeading: 'Need order help?',
    contactBody: 'Send your order reference or WhatsApp conversation to hello@prabaleather.com. Our team will confirm the next step, shipping details, or return eligibility.',
  },
  cookies: {
    ...
    contactBody: 'Contact hello@prabaleather.com if you want to understand or request deletion of information shared with Praba Leather Bali. Browser storage can be cleared directly from your device.',
  },
};
...
const id: Record<LegalSlug, LegalPolicy> = {
  privacy: {
    ...
    sections: [
      { heading: '1. Tentang kami', paragraphs: ['Praba Leather Bali adalah studio barang kulit dan storefront online yang berbasis di Bali. Untuk pertanyaan atau permintaan privasi, hubungi hello@prabaleather.com atau +62 818 0459 5666.'] },
      ...
      { heading: '7. Pilihan dan hak Anda', paragraphs: ['Bergantung pada lokasi Anda dan hukum yang berlaku, Anda dapat meminta akses, koreksi, penghapusan, pembatasan, atau penghentian penggunaan informasi pribadi, serta menarik persetujuan jika pemrosesan didasarkan pada persetujuan. Anda juga dapat menanyakan cara kami menggunakan informasi atau menolak pemasaran langsung. Hubungi hello@prabaleather.com dengan email atau nomor telepon yang digunakan dalam percakapan agar kami dapat memverifikasi permintaan dengan aman.'] },
    ...
    contactBody: 'Email hello@prabaleather.com atau telepon +62 818 0459 5666. Kami berupaya mengakui permintaan privasi dalam tujuh hari dan merespons setelah permintaan diverifikasi.',
  },
  terms: {
    ...
    sections: [
      ...
      { heading: '5. Pengiriman dan pengembalian', paragraphs: ['Ketersediaan, kurir, ongkos, bea, dan perkiraan pengiriman bergantung pada tujuan dan dikonfirmasi secara individual. Periksa kiriman segera dan hubungi hello@prabaleather.com dalam 48 jam dengan foto jika item rusak atau tidak sesuai.', 'Untuk permintaan pengembalian, hubungi kami dalam tujuh hari sejak barang diterima sebelum mengirimkannya kembali. Barang harus belum digunakan, belum diubah, dan dikembalikan dengan kemasan asli. Emboss custom, pekerjaan pesanan khusus, barang yang sudah digunakan, atau barang yang rusak setelah diterima dapat tidak memenuhi syarat pengembalian. Kami akan mengonfirmasi solusi, alamat pengembalian, dan biaya sebelum barang dikirim.'] },
      ...
      { heading: '9. Kontak dan konteks hukum', paragraphs: ['Pertanyaan, keluhan, dan masalah pesanan sebaiknya terlebih dahulu dikirim ke hello@prabaleather.com. Ketentuan ini dimaksudkan untuk dibaca bersama hukum yang berlaku pada operasional Praba Leather Bali di Indonesia dan perlindungan konsumen wajib yang berlaku pada pembelian Anda.'] },
    ],
    contactHeading: 'Butuh bantuan pesanan?',
    contactBody: 'Kirim referensi pesanan atau percakapan WhatsApp ke hello@prabaleather.com. Tim kami akan mengonfirmasi langkah berikutnya, detail pengiriman, atau kelayakan pengembalian.',
  },
  cookies: {
    ...
    contactBody: 'Hubungi hello@prabaleather.com jika ingin memahami atau meminta penghapusan informasi yang telah dibagikan kepada Praba Leather Bali. Penyimpanan browser dapat dihapus langsung dari perangkat Anda.',
  },
};
